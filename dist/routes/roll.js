...
fs_1.default.writeFileSync(path_1.default.join(__dirname, '../players/player2.json'), JSON.stringify({ id: 2, balance: 1000, free_spins: 0, screen: ['EFS', 'DEJ', 'GDB', 'FCJ', 'SCJ'] }));
